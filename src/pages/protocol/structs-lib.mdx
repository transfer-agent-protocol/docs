...
[Structs](https://github.com/transfer-agent-protocol/tap-cap-table/blob/main/chain/src/lib/Structs.sol) manage various aspects of the cap table, including issuers, stock classes, stakeholders, and different types of stock transactions.
